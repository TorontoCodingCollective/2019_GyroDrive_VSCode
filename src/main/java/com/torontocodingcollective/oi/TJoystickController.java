 ...
 * to access all buttons and axis by name.
 * <p>
 * This abstract class has 3 known implementations
 * <br> {@link TJoystickController_Logitech}
 *
 */
public abstract class TJoystickController extends Joystick {
	 ...
	 * @param axis {@link TAxis#X}, {@link TAxis#Y}, {@link TAxis#TWIST} 
	 * or {@link TAxis#SLIDER}
	 * 
	 ...
	 * @param button a valid {@link TButton} value for thisTJoystickController.
	...
	public TStickPosition getStickPosition() {
		return new TStickPosition(
				getAxis(TAxis.X), getAxis(TAxis.Y));
	};
	 ...
	 * or activating an stick on the controller
	 * <p>
	 * NOTE: The slider value is not checked because it 
	 *       does not return to a home state.  If the 
	 *       user is only moving the slider, that will
	...
	public String toString() {
		...
		sb
		.append(' ').append(getStickPosition())
		.append(" Twist(").append(getAxis(TAxis.TWIST)).append(')')
