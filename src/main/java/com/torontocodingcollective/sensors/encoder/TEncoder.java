 ...
 * <p>
 * The encoder interface is not consistent for PWM and CAN
 * encoders, and this interface is used to unify that interface
 * <p>
...
public abstract class TEncoder {
	 ...
	 * @param encoderCount to set the encoder to
	 */
	 ...
	 * <p>
	 * A call to setInverted also resets the encoder
	 * if the inversion changes
	 * 
	 * @param isInverted {@code true} if the output
