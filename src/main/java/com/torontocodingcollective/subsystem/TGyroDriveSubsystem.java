...
public abstract class TGyroDriveSubsystem extends TDriveSubsystem {
	 ...
	 * @param gyroKP            Default Proportional gain for the gyro angle pid.
	 *                          The gyro PID is displayed on the SmartDashboard and
	 *                          can be adjusted through that interface
	 * @param gyroKI            Default Integral gain for the gyro angle pid. The
	 *                          gyro PID is displayed on the SmartDashboard and can
	 *                          be adjusted through that interface
	 * @param maxRotationOutput used to control the rotation of the robot when
	 ...
	 * @param speedKP              Default Proportional gain for the motor speed
	 *                             pid. The speed PIDs are displayed on the
	 *                             SmartDashboard and can be adjusted through that
	 *                             interface
	 * @param maxEncoderSpeed      the max loaded robot encoder rate used to
	 *                             normalize the PID input encoder feedback.
	 * @param gyro                 that extends {@link TGyro}
	 * @param gyroKP               Default Proportional gain for the gyro angle pid.
	 *                             The gyro PID is displayed on the SmartDashboard
	 *                             and can be adjusted through that interface
	 * @param gyroKI               Default Integral gain for the gyro angle pid. The
	 *                             gyro PID is displayed on the SmartDashboard and
	 *                             can be adjusted through that interface
	 * @param maxRotationOutput    used to control the rotation of the robot when
	 *                             rotating to an angle
	 */
	...
	/**
	 * Enable the gyroPID with the specified heading as 
	 * a setpoint
	 ...
	 * the joysticks).
	 *
	 * @param maxRotationOutput to use on the output motors when rotating the robot
	 *                          a value of zero will be overridden to 0.5 (half
	 *                          output)
	 */
