 ...
 * Drive Time Command
 * <p>
 * This command will drive straight (no gyro compensation) for the 
...
public class TDriveTimeCommand extends TSafeCommand {
	...
	/**
	 * DriveTimeCommand
	 * @param speed at which to drive in the range -1.0 <= speed <= 1.0.
	 ...
	 */
    public TDriveTimeCommand(double speed, double timeout, 
    		TOi oi, TDriveSubsystem driveSubsystem) {
