...
public abstract class TSpeedController implements SpeedController {
	 ...
	 *       compile reasons to support the {@link SpeedController} interface
	 *       and in case a TSpeedController is used in a wpilib {@link PIDController}.
	 *       It is recommended instead to use the TorontoJar {@link TSpeedPID} instead
	 */
	@Override
