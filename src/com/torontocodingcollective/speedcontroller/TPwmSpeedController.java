...
/**
 * TPwmSpeedController controls one or more speed controllers of the same type connected to the 
 * PWM interface on the RoboRio.
 * <p>
...
public class TPwmSpeedController extends TSpeedController {
	 ...
	 * <p>
	 * Supports any number of PWM speed controllers of the same type driving in the same direction.  The same
	 * output signal will be sent to all PWM ports associated with this controller.
	 * 
	 * @param controllerType a valid {@link TPwmSpeedControllerType}
	 * @param pwmPort the port number of the primary controller
	 * @param isInverted {@code true} if the motors are inverted, {@code false} otherwise
	 * @param followerPwmPorts and optional list of follower ports
	 */
	 ...
	 * PWM Speed Controller
	 * <p>
	 * Supports two PWM speed controllers of different types driving the same drive train.
	 * The same output signal will be sent to the follower PWM ports.
	 * 
	 * @param controllerType a valid {@link TPwmSpeedControllerType}
	 * @param pwmPort the port number of the primary controller
	 * @param followerControllerType a valid {@link TPWMControllerType}
	 * @param followerPwmPort the port number of the primary controller
	 */
	 ...
	 * @param controllerType a valid {@link TPwmSpeedControllerType}
	 * @param pwmPort the port number of the primary controller
	 * @param followerControllerType a valid {@link TPwmSpeedControllerType}
	 * @param followerPwmPort the port number of the primary controller
	 * @param isInverted {@code true} if the motors are inverted, {@code false} otherwise
	 */
