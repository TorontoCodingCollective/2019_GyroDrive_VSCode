...
public class TSpeedPID extends PIDController {
	 ...
	 * @param normalizedRate the encoder rate scaled for use as 
	 * used as feedback for this PID (should be set to rawRate/maxEncodeSpeed)
	 ...
	 * <p>
	 * The setpoint for a TSpeedPid must be between -1.0 and 1.0 (full range for a speed controller).
	 * <p>
	 * Inherits: 
	 * {@inheritDoc}
	 */
	...
	public void setSetpoint(double setpoint) {
		if (setpoint > 1.0) {
			System.out.println("Cannot set TSpeedPID setpoint > 1.0.  Attempted to set value to " 
					+ setpoint + ". Overriding to 1.0");
			setpoint = 1.0;
		}
