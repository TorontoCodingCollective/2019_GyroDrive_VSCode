 ...
 * A null PID Output
 * <p>
 * This class is used to easily construct a #{@link edu.wpi.first.wpilibj.PIDController}
 * that has no defined output.
 * <p>
 * The TorontoJar class {@link TSpeedPID} extends the wpilib PIDController in order to 
