...
public class TButtonPressDetector {
	 ...
	 * since subsequent calls will always return {@code false}
	...
	/*
	 * Get the button state based of the button attached to the 
	 * button press detector (based on type of button).
